...
export default function LandingPage() {
  ...
  const testimonials = [
    {
      ...
      role: "Cardiologist",
      text: "CareSync 360 has transformed how I manage my practice. The seamless appointment system and medical record integration saves me hours every week.",
      stars: 5,
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes, CareSync 360 provides a comprehensive doctor dashboard with patient management, scheduling, analytics, medical record creation, and prescription tools.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section
        id="home"
        className="relative min-h-screen flex items-center pt-28 md:pt-32 pb-16 md:pb-24 overflow-hidden"
      >
        ...
        <div
          ...
          style={{
            ...
            zIndex: 5,
            background:
              "radial-gradient(ellipse at center, rgba(13,148,136,0.42) 0%, rgba(6,182,212,0.22) 35%, rgba(13,148,136,0.10) 60%, transparent 80%)",
            filter: "blur(90px)",
            borderRadius: "50%",
          }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center relative">
            <div
              ...
              style={{
                ...
                zIndex: 5,
                background:
                  "radial-gradient(ellipse at center, rgba(13,148,136,0.45) 0%, rgba(6,182,212,0.25) 35%, rgba(13,148,136,0.12) 60%, transparent 80%)",
                filter: "blur(100px)",
                borderRadius: "50%",
              }}
            />
            ...
            <div className="lg:col-span-5 lg:col-start-7">
              ...
              <p
                ...
                style={{ color: "#6C6863" }}
              >
                CareSync 360 bridges the gap between patients and healthcare
              ...
              <div className="mt-8">
                <Link to="/register-patient" className="lp-btn-primary">
                  <span className="btn-gold-bg" />
                  <span className="btn-label flex items-center gap-2">
                    Join CareSync Today <ArrowRight size={14} />
                  </span>
                </Link>
              </div>
            </div>
      ...
      <FadeSection className="lp-cta-section py-20 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-16 text-center relative z-10">
          ...
          >
            Join thousands of patients and doctors who trust CareSync 360 for
      ...
      <footer className="lp-footer py-16 md:py-20">
        <div className="max-w-[1600px] mx-auto px-6 md:px-16 relative z-10">
          ...
          >
            ...
            >
              &copy; {new Date().getFullYear()} CareSync 360. All rights
              reserved.
            </p>
            <p
              className="lp-sans"
