      ...
      {showFade && (
        <>
          <div
            ...
            style={{
              background: "#F9F8F6",
              maskImage: `radial-gradient(ellipse at center, transparent ${fadeIntensity}%, black 90%)`,
              WebkitMaskImage: `radial-gradient(ellipse at center, transparent ${fadeIntensity}%, black 90%)`,
            }}
          />
          <div
            ...
            style={{
              height: "15%",
              background:
                "linear-gradient(to bottom, #F9F8F6 0%, transparent 100%)",
            }}
          />
          <div
          ...
          <div
            ...
            style={{
              width: "12%",
              background:
                "linear-gradient(to right, #F9F8F6 0%, transparent 100%)",
            }}
          />
          <div
            ...
            style={{
              width: "12%",
              background:
                "linear-gradient(to left, #F9F8F6 0%, transparent 100%)",
            }}
          />
        </>
      )}
